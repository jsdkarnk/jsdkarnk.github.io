...
var ytEmbed = {
    ...
    listVideos: function (json, cfg) {
        ...
        for (var i = children.length; i > -1; i--) {
            if (children[i] && (children[i].className.indexOf("error") !== -1 || children[i].tagName === "UL" || children[i].tagName === "INS")) {
                /* is error message or result list */
    ...
    createPlayer: function (cfg) {
        ...
        iframe.setAttribute('src', 'https://www.youtube.com/embed/' + ytPlayerParams.videoId + '?autoplay=1&mute=0&modestbranding=1'); //controlbar set
